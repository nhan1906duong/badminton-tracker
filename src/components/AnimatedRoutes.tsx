...
const routes = [
  ...
  { path: '/', element: <Navigate to="/sessions" replace />, auth: false },
  { path: '/sessions', element: <SessionsListPage />, auth: false },
  { path: '/sessions/active', element: <ActiveSessionRedirect />, auth: true },
  { path: '/sessions/new', element: <CreateSessionPage />, auth: true },
  { path: '/sessions/:id', element: <SessionDetailPage />, auth: false },
  { path: '/sessions/:id/stats', element: <SessionStatsPage />, auth: false },
  { path: '/sessions/:id/matches/new', element: <CreateMatchPage />, auth: true },
  { path: '/sessions/:id/matches/:matchId', element: <MatchDetailPage />, auth: false },
  ...
  { path: '/settings', element: <SettingsPage />, auth: false },
